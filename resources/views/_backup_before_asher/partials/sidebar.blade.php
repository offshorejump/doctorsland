...
<aside class="main-sidebar">   
  ...
  <section class="sidebar"> 
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="{{ url('/accounts/admins') }}"><i class="fa fa-link"></i> <span>Administrators</span></a></li>
      <li><a href="{{ url('/accounts/doctors') }}"><i class="fa fa-link"></i> <span>Doctors</span></a></li>
