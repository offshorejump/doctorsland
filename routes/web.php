...
Route::resource('patient/get-patient', 'PatientController@get_by_Id');
Route::resource('patient/update-patient', 'PatientController@update');
Route::resource('patient/delete', 'PatientController@delete');
...
Route::resource('patient/referedtome', 'ReferController@referedtome');
Route::resource('patient/view', 'ReferController@view_by_id');
...
Route::resource('types/new', 'TypesController@new_type');
Route::resource('types/new_type', 'TypesController@new_type_form');
Route::resource('types/add_new', 'TypesController@save_new_type');
Route::resource('types/get-type', 'TypesController@get_type');
Route::resource('types/update-type', 'TypesController@update_type');

/**
 *  Settings routes
 **/
Route::get('settings/profile', 'ProfileSettingController@get_profile');
Route::resource('settings/profile/update', 'ProfileSettingController@update_profile');
